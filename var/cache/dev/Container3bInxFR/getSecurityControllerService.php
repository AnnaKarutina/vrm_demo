...
class getSecurityControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.Ohb2d9A'] ?? $container->load('get_ServiceLocator_Ohb2d9AService'))->withContext('App\\Controller\\SecurityController', $container));
